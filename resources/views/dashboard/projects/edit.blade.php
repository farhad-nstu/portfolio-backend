      ...
      <div class="nk-block nk-block-middle nk-auth-body"> 
        <div class="nk-block-head">
          <div class="nk-block-head-content">
            <h5 class="nk-block-title">Edit Project</h5> 
          </div>
        </div>
        ...
        <form method="POST" action="{{route('project.update', $project->id)}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ $project->title }}" name="title">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg @error('link') is-invalid @enderror" value="{{ $project->link }}" name="link">
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="summernote-basic" name="description">{{ $project->description }}</textarea>
          </div>
