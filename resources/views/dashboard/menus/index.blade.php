...
<div class="nk-block nk-block-lg">
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            <h4 class="nk-block-title text-warning">Menus List</h4>
            <div class="float-right mb-3">
              <a href="{{ route('menus.create') }}" class=" btn btn-icon btn-primary"><em
                     ...
                     @forelse ($menus as $menu)
                        <tr> 
                          <td>{{$loop->index + 1}}</td>                        
                            ...
                            <td>
                                <a class="btn btn-sm btn-success" href="{{ route('menus.edit', $menu->id) }}" title="Edit">
