      ...
      <div class="nk-block nk-block-middle nk-auth-body"> 
        <div class="nk-block-head">
          <div class="nk-block-head-content">
            <h5 class="nk-block-title">Add About Information</h5> 
          </div>
        </div>
        ...
        <form method="POST" action="{{route('about.store')}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg @error('designation') is-invalid @enderror" value="{{ old('designation') }}" name="designation">
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="form-control form-control-lg" id="full-name" name="short_name_desc"></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg @error('current_focus') is-invalid @enderror" value="{{ old('current_focus') }}" name="current_focus">
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="summernote-basic" id="full-name" name="professional_experience"></textarea>
          </div>

          <div class="form-group">
            <label class="form-label">Course</label>
            <input type="text" class="form-control form-control-lg @error('course') is-invalid @enderror" value="{{ old('course') }}" name="course">
